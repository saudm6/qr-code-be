...
using qr_code_be.Application.TodoItems.Commands.UpdateTodoItem;
using qr_code_be.Application.TodoItems.Commands.UpdateTodoItemDetail;
using qr_code_be.Application.TodoItems.Queries.GetTodoItemsWithPagination;

namespace qr_code_be.Web.Endpoints;
