...
using qr_code.Application.Common.Models;
using qr_code.Application.TodoItems.Commands.CreateTodoItem;
using qr_code.Application.TodoItems.Commands.DeleteTodoItem;
using qr_code.Application.TodoItems.Commands.UpdateTodoItem;
using qr_code.Application.TodoItems.Commands.UpdateTodoItemDetail;
using qr_code.Application.TodoItems.Queries.GetTodoItemsWithPagination;
