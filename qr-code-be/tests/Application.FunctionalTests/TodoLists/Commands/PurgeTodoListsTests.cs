using qr_code_be.Application.Common.Exceptions;
using qr_code_be.Application.Common.Security;
using qr_code_be.Application.TodoLists.Commands.CreateTodoList;
using qr_code_be.Application.TodoLists.Commands.PurgeTodoLists;
