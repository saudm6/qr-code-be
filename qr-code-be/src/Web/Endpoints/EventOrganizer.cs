...
using qr_code_be.Application.EventOrganizers.Commands.CreateEventOrganizer;
using qr_code_be.Application.EventOrganizers.DTO;
using qr_code_be.Application.EventOrganizers.Queries;
